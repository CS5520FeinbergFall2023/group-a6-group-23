...
public class ReviewStickersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_review_stickers);
    ...
    private void update() {
        ...
        received.setAdapter(new ReviewRecyclerViewAdapter(stickers));
