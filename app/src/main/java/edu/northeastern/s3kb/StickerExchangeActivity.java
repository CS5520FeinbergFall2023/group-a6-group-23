...
public class StickerExchangeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sticker_exchange);  // images
    ...
    public void showHistory(View view) {
        Intent intent = new Intent(this, ReviewStickersActivity.class);
    ...
    private void sendNotification(Sticker sticker) {
        Intent intent = new Intent(this, StickerExchangeActivity.class);
