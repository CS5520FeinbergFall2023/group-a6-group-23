...
public class InterbankTransactionActivity extends AppCompatActivity implements DataFetcherTask.DataFetchListener {
    ...
    public void onDataFetched(String data) {
        try {
            ...
            int[] months = {R.drawable.jan, R.drawable.feb,R.drawable.mar,R.drawable.apr,
                    ...
                    R.drawable.aug, R.drawable.sep, R.drawable.oct, R.drawable.sep, R.drawable.sep};
            ...
            for (int i = 0; i < dataArray.length(); i++) {
                ...
                String totalTrans = dataObject.getString("date");
                String percentage = dataObject.getString("volume");
                int effMonth = Integer.parseInt(totalTrans.split("-")[1]);
                itemList.add(i, new ItemCard(effMonth == 0 ? R.drawable.jan: months[effMonth - 1], totalTrans, percentage));
